...
class supplier(models.Model):
    ...
    email = models.EmailField()
    img = models.ImageField()
    product = models.ForeignKey(pha_product,on_delete=models.CASCADE,null=True,related_name='supplier')
...
class Purchase(models.Model):
    ...
    supplir = models.ForeignKey(supplier,null=True,on_delete=models.CASCADE,related_name='purchase')
